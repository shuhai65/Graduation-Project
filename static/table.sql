...
(
    ...
    username    VARCHAR(20)  NOT NULL COMMENT '用户名',                                                         -- 用户名，不允许为空
    password    VARCHAR(50)  NOT NULL COMMENT '密码',                                                           -- 密码，不允许为空
    ...
    INDEX idx_main_info (username, password, id) USING BTREE COMMENT '主要信息索引'                             -- 主要信息索引
) COMMENT '用户信息表';
...
# 初始化角色信息
INSERT INTO aquarium_role (role_name) VALUES ('user');
INSERT INTO aquarium_role (role_name) VALUES ('admin');

# 初始化权限信息
INSERT INTO aquarium_permission (permission_name) VALUES ('user:normal');
INSERT INTO aquarium_permission (permission_name) VALUES ('admin:normal');

# 初始化角色权限关联信息
INSERT INTO aquarium_role_permission (role_id, permission_id) VALUES (1, 1);
INSERT INTO aquarium_role_permission (role_id, permission_id) VALUES (2, 2);